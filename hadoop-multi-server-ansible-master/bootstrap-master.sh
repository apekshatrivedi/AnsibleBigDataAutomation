...
sudo -E apt-get install software-properties-common python-software-properties -y
sudo -E apt-add-repository ppa:ansible/ansible -y
sudo -E apt-get update
sudo -E apt-get install ansible -y
#sudo -E apt-get install ansible -y
...
sudo pip install python-heatclient python-openstackclient pyopenssl ndg-httpsclient pyasn1
